...
#ifndef SLSEIGERIMAGESIZE_H_
#define SLSEIGERIMAGESIZE_H_
...
public:
    ...
    void updateImageFormat()
    {
        ...
        lima::ImageType image_depth;
        lima::Size      image_size ;

        // specific part from the camera plugin [START]
        image_size  = Size(getWidth(), getHeight());
    	image_depth = getImageType();
