...
/*************************************************************************/
/*! 
 *  \file   SlsEigerInterface.h
 *  \brief  SlsEiger hardware class interface 
 *  \author Cédric Castel - SOLEIL (MEDIANE SYSTEME - IT consultant) 
*/
/*************************************************************************/

#ifndef SLSEIGERINTERFACE_H
#define SLSEIGERINTERFACE_H

#include "lima/Debug.h"
#include "SlsEigerCompatibility.h"
#include "SlsEigerDetInfoCtrlObj.h"
#include "SlsEigerSyncCtrlObj.h"
...
namespace lima
{
    namespace SlsEiger
    {
        ...
        /*******************************************************************
         * \class Interface
         * \brief SlsEiger hardware interface
         *******************************************************************/

        class LIBSLSEIGER_API Interface: public HwInterface
        {
            DEB_CLASS_NAMESPC(DebModCamera, "SlsEigerInterface", "SlsEiger");
