...
/*************************************************************************/
/*! 
 *  \file   SlsEigerDetInfoCtrlObj.h
 *  \brief  SlsEiger detector info class interface 
 *  \author Cédric Castel - SOLEIL (MEDIANE SYSTEME - IT consultant) 
*/
/*************************************************************************/

#ifndef SLSEIGERDETINFOCTRLOBJ_H
#define SLSEIGERDETINFOCTRLOBJ_H
...
namespace lima 
{
    namespace SlsEiger 
    {
         ...
         * \brief Control object providing SlsEiger detector info interface
         ***********************************************************************/

        class LIBSLSEIGER_API DetInfoCtrlObj: public HwDetInfoCtrlObj 
        {
            DEB_CLASS_NAMESPC(DebModCamera, "DetInfoCtrlObj", "SlsEiger");
...
#endif // SLSEIGERDETINFOCTRLOBJ_H
